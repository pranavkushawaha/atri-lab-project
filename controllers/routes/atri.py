...
class Atri:
	def __init__(self, state: Any):
		...
		self.Favourite_app = state["Favourite_app"]
	...
	def Favourite_app(self):
		self._getter_access_tracker["Favourite_app"] = {}
		return self._Favourite_app
	@Favourite_app.setter
	def Favourite_app(self, new_state):
		self._setter_access_tracker["Favourite_app"] = {}
		global default_state
		self._Favourite_app = Div(new_state, default_state["Favourite_app"])
	...
	def Menu(self, new_state):
		...
		global default_state
		self._Menu = Div(new_state, default_state["Menu"])
	...
	def About_us(self, new_state):
		...
		global default_state
		self._About_us = Div(new_state, default_state["About_us"])
	...
	def Burger(self, new_state):
		...
		global default_state
		self._Burger = Div(new_state, default_state["Burger"])
	...
	def Insta(self, new_state):
		...
		global default_state
		self._Insta = Flex(new_state, default_state["Insta"])
	...
	def _to_json_fields(self):
		return {
			...
			"Flex8": self._Flex8,
			"Favourite_app": self._Favourite_app,
			"Flex9": self._Flex9,
			"Menu": self._Menu,
			"Flex10": self._Flex10,
			"Div13": self._Div13,
